...
const Reports: React.FC = () => {
  ...
  return (
    <>
      {/* Keep DeliveryReport mounted but hidden when not selected */}
      <Box sx={{ display: selectedReport === "delivery" ? "block" : "none" }}>
        <DeliveryReport
          key="delivery-report"
      ...
      {/* Report listing - hidden when a report is selected */}
      <Box sx={{ display: selectedReport === null ? "block" : "none", p: 3 }}>
